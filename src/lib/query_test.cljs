...
(deftest pagination
  (testing "to-page-count"
    (is (= (query/to-page-count {:q/limit 20 :q/offset 0} 20) 1))
    (is (= (query/to-page-count {:q/limit 20 :q/offset 20} 20) 2))
    (is (= (query/to-page-count {:q/limit 20 :q/offset 40} 20) 3))
    (is (= (query/to-page-count {:q/limit 20 :q/offset 60} 20) 4)))



  (testing "to-page-numbers"
    ;; Basic cases
    (is (= (query/to-page-numbers {:q/limit 20 :q/offset 0} 20) [1]))
    (is (= (query/to-page-numbers {:q/limit 40 :q/offset 0} 20) [1 2]))
    (is (= (query/to-page-numbers {:q/limit 40 :q/offset 20} 20) [2 3]))
    (is (= (query/to-page-numbers {:q/limit 40 :q/offset 40} 20) [3 4]))

    ;; Partial page overlaps
    (is (= (query/to-page-numbers {:q/limit 20 :q/offset 10} 20) [1 2]))
    (is (= (query/to-page-numbers {:q/limit 20 :q/offset 20} 20) [2]))
    (is (= (query/to-page-numbers {:q/limit 20 :q/offset 30} 20) [2 3]))
    (is (= (query/to-page-numbers {:q/limit 20 :q/offset 45} 20) [3 4]))
    ...
    (is (= (query/to-page-numbers {:q/limit 10 :q/offset 7} 5) [2 3 4])))
  ...
  (testing "to-pages"
    ...
    #_(is (= (query/to-pages {:q/limit 1 :q/offset 999} 20)
    ...
    ;; Very large values
    (is (= (query/to-pages {:q/limit 100 :q/offset 80} 20)
